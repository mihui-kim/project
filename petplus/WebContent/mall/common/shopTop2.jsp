...
<div class="top">
		...
		<!-- 검색 -->
		<div class="t_search"> 
			<form action="shopAll.jsp" method="post" name="searchForm">
				<input type="search" name="keyword" id="keyword" placeholder="SEARCH">
				<button type="submit"  id="img_search"><img src="../../icons/t_search.png" width="30" height="30"></button>
			</form>
		</div>
</div>
</body>